...
class RasaOutcomeDeterminer(OutcomeDeterminerBase):
    ...
    ## ToDo: Change method name, probs don't need to modify method itself though, just need to change mentions of rasa
    ...
    def initialize_extracted_entities(self, entities: Dict):
        ...
        for extracted in entities:
            if extracted["entity"] in SPACY_LABELS:
                ...
                ## ToDo: Change to avoid mention of rasa
                self.rasa_entities[extracted["entity"]] = extracted

    ## ToDo: Remove rasa, find another method to try
    ...
    ## ToDo: Similar to above, remove rasa and find another method to try
    ...
    def extract_regex(self, entity):
        ...
        ## ToDo: Replace rasa with new method
    ...
    def extract_entity(self, entity: str):
        ...
        if self.context_variables[entity]["type"] == "json":
            ...
            if method == "spacy":
                ## ToDo: replace method name when we have a new one
