...
def experiment_dialogues_no_agg(articles: List[List[str]], _scorer_function: Callable[[str, str], float],
                                n_pretext_sentences: int = 5):
    """
    ...
    for i, article in enumerate(articles):
        ...
        sentence_scores_a = score_sentences(article, _scorer_function, n_pretext_sentences=n_pretext_sentences,
                                            verbose=0)
